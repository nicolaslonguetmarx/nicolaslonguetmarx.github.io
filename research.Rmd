...
Party Lines or Voter Preferences? Explaining Political Realignment. <span style="font-weight: 900; font-size: 1em; -webkit-text-stroke: 0.5px black;"> Job Market Paper. </span>  [Available upon request]   <br />
...
<div class="abstract-content">
A core question in political economy is how to decouple demand factors (voters) from supply factors (politicians) in driving political equilibria. This question is particularly crucial in the context of major changes in the equilibrium such as the recent realignment of blue-collar voters away from the Democratic party in the United States. 
I build and estimate a multidimensional political equilibrium model to decompose any change in observed equilibria into demand and supply side factors. To measure positioning on the supply side, I estimate a multimodal text-and-survey model from candidate campaign websites, which reveals that candidate polarization on cultural issues between 2000 and 2020 has been twice larger than on economic issues. To measure demand, I construct a new panel dataset of precinct-level election results in Congressional races since 2000 and estimate a model of voter preferences for economic and cultural policy positions, varying across time and demographic groups. I find that educated voters prefer more progressive cultural policies but more conservative economic policies. 
Then, on the supply side, using a model of political positioning where candidates balance electability with compliance with the party line, I document a rise in party discipline: House candidates' tailoring of their positions to their local conditions has declined by 70%. 
Ultimately, I show that realignment is almost entirely driven by changes in positioning of both political parties rather than shifts in voter preferences, with parties polarizing more on the cultural than economic dimension, reinforced by a rise in party discipline.
Finally, I simulate counterfactual levels of support for the introduction of a new political dimension - the environment - and show that a progressive environmental policy involving economic measures would generate much more support from low-education voters than those involving cultural ones.
</div>
...
Non-linear Impacts of Climate Change on Income and Inequality in Viet Nam, with Etienne Espagne and Ngo Duc Thanh. [AFD Working Paper 2019-101](https://www.afd.fr/en/ressources/non-linear-impacts-climate-change-income-and-inequality-vietnam), Revise and Resubmit at <em>World Development</em>.  <br />
...
# Work in Progress
Climate Voting in the United States, with [Matilde Bombardini](https://matildebombardini.github.io), [Frederico Finan](https://eml.berkeley.edu//~ffinan/), [Suresh Naidu](https://sites.santafe.edu/~snaidu/), and [Francesco Trebbi](https://ftrebbi.com)


The Nationalization of American Lawmaking? Evidence from State Statutes, with [Charles Angelucci](https://sites.google.com/site/charlesangelucci/) and [Elliott Ash](https://elliottash.com)
